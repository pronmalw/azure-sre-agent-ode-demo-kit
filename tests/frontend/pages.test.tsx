...
import { Layout } from '../../src/web/src/components/Layout';
import { CartPage } from '../../src/web/src/pages/CartPage';
import { HomePage } from '../../src/web/src/pages/HomePage';
import { OpsControlPanel } from '../../src/web/src/pages/OpsControlPanel';
import { ProductsPage } from '../../src/web/src/pages/ProductsPage';
import { SreAgentPage } from '../../src/web/src/pages/SreAgentPage';
...
describe('frontend pages', () => {
  ...
  it('Layout renders header with Contoso Retail brand', () => {
    ...
    expect(screen.getByText(/Contoso Retail/i)).toBeInTheDocument();
  });
});
